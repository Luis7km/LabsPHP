...
<html>
    ...
    <body>
        <?php
            if (empty($_REQUEST['contenido-pub']) && !is_file($_FILES['imagen']['tmp_name'])) {
                echo '<script>open_publicar(); alert("Debe llenar por lo menos, el campo de contenido o el campo de imagen!")</script>';
            } else {
